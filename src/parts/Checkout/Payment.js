                ...
                <div className="row justify-content-center align-items-center">
                    ...
                    <div className="col-5 py-5" style={{ paddingLeft: 80 }}>
                        <Fade delay={600}>
                            ...
                            <InputText id="bankName" name="bankName" onChange={props.onChange} value={data.bankName} type="text" />

                            <label htmlFor="bankHolder">Nama Pengirim</label>
                            <InputText id="bankHolder" name="bankHolder" onChange={props.onChange} value={data.bankHolder} type="text" />
                        </Fade>
                    </div>
                </div>
            </div>
