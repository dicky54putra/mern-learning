                            ...
                            <>
                                ...
                                {CurrentStep === "bookingInformation" && (
                                    <Controller>
                                        ...
                                        <Button className="btn" type="link" isBlock href={`/properties/${ItemDetails._id}`}> Cancel </Button>
                                    </Controller>
                                )}
                                {CurrentStep === "payment" && (
                                    <Controller>
                                        ...
                                        <Button className="btn" type="button" isBlock onClick={prevStep}>
                                            Cancel
                                                        </Button>
                                    </Controller>
                                )}
                                {CurrentStep === "completed" && (
                                    <Controller>
                                        <Button className="btn mb-3" type="link" isBlock isPrimary hasShadow href=""> Back to Home </Button>
                                    </Controller>
                                )}
                            </>
                        )
